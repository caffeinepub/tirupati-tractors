          ...
          {submitted ? (
            ...
            >
              ...
              <p className="text-muted-foreground text-sm mb-6">
                Thank you, <strong>{form.name}</strong>! Our team will call you
                at <strong>{form.phone}</strong> within 24 hours.
              </p>
              <Button
                onClick={handleReset}
                variant="outline"
            ...
            <div className="bg-card border border-border rounded-xl p-8 shadow-card">
              ...
              >
                ...
                <div>
                  <Label htmlFor="page-enq-model">Select Tractor Model *</Label>
                  <Select
                    value={form.model}
