...
export class Backend implements backendInterface {
    ...
    async claimAdminByEmail(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.claimAdminByEmail(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getShowroomInfo(): Promise<ShowroomInfo> {
        if (this.processError) {
            try {
                const result = await this.actor.getShowroomInfo();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateShowroomInfo(arg0: ShowroomInfo): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.updateShowroomInfo(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
